...
router.patch("/profile/change-username", validateChangeUsername, validate, profileControllers.changeUsername);
...
router.patch("/profile/change-email", validateChangeEmail, validate, profileControllers.changeEmail);
router.patch(
